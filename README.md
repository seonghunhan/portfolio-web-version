...
#### 배운점
- 프론트단에서 어떻게 Data를 다루는지 알 수 있어서 좋았습니다.
- GitFlow 협업 방식을 처음 해봤고, Git의 편리함을 느낄 수 있었습니다. 
- Redis를 활용해 금융권에서 실제 사용하는 PV, UV단위를 다룰 수 있었던 좋은 기회였습니다.
- MVC패턴과 비즈니스로직 개념에 대해 한번 더 확립할 수 있었습니다.
  
#### 아쉬운점
- 전체적으로 성능 테스트를 해보고 싶었지만 못해서 아쉬웠습니다.
- 이중DB나 로드밸런싱같은 DevOps역량을 높이고 싶었지만 못해서 아쉬웠습니다.
